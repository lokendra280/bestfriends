                ...
                <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                    <div class="sm:flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('products') }}" :active="request() - > routeIs('products')"
                                class="py-2 mx-2 px-10 rounded-full hover:text-indigo-700 hover:bg-indigo-100 ">
                                All
                            </a>
                        ...
                        <table class="w-full whitespace-nowrap">
                            <tbody>
                                ...
                                <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                                    ...
                                    <td>
                                        <button type="button"
                                            class="inline-block px-6 py-2.5 bg-yellow-400 text-white font-medium text-xs leading-tight uppercase rounded shadow-md  hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 "
                                            wire:click="restore({{ $product->id }})">Resotore</button>
                                    </td>

                                    <!-- <td>
                                        <button type="button" class="inline-block px-6 py-2.5 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out" wire:click="delProduct({{ $product->id }})">Delete</button>
                                    </td> -->
